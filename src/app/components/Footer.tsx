  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-12 lg:px-16 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-8 sm:gap-10 md:gap-12 lg:gap-[60px] mb-10 sm:mb-12 md:mb-[60px]">
          {/* Brand */}
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            >
              ...
              >
                <path d="M52.1482 141.333C44.2934 141.333 37.9259 134.966 37.9259 127.111V60.7407H2.26056e-06V141.333C1.01209e-06 162.279 16.98 179.259 37.9259 179.259L75.8519 141.333H52.1482Z" fill="white"/>
                <path d="M127.998 141.333C120.143 141.333 113.776 134.966 113.776 127.111V60.7407H75.8496V141.333C75.8496 162.279 92.8296 179.259 113.776 179.259L151.701 141.333H127.998Z" fill="white"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M189.631 60.7407H151.705V141.333L189.631 103.407V60.7407Z" fill="white"/>
                <path d="M189.568 148.431L188.88 149.625C183.822 158.411 183.822 169.224 188.88 178.01L189.568 179.203L188.374 178.516C179.588 173.458 168.775 173.458 159.989 178.516L158.796 179.203L159.483 178.01C164.541 169.224 164.541 158.411 159.483 149.625L158.796 148.431L159.989 149.119C168.775 154.177 179.588 154.177 188.374 149.119L189.568 148.431Z" fill="white"/>
                <path d="M880.584 183.825V133.034C880.584 125.688 882.363 119.03 885.921 113.061C889.479 107.093 894.53 102.329 901.072 98.771C907.73 95.2127 915.592 93.4336 924.66 93.4336C933.843 93.4336 941.648 95.2127 948.076 98.771C954.619 102.329 959.612 107.093 963.055 113.061C966.499 119.03 968.22 125.688 968.22 133.034V183.825H941.533V133.722C941.533 130.623 940.787 127.811 939.295 125.286C937.803 122.646 935.737 120.58 933.097 119.088C930.572 117.481 927.702 116.677 924.488 116.677C921.159 116.677 918.175 117.481 915.535 119.088C913.01 120.58 911.001 122.646 909.509 125.286C908.017 127.811 907.271 130.623 907.271 133.722V183.825H880.584Z" fill="white"/>
                <path d="M835.607 183.819V95.4939H862.466V183.819H835.607Z" fill="white"/>
              ...
              {[
                {
                  ...
                  icon: <svg viewBox="0 0 24 24" className="w-4 h-4 flex-shrink-0" fill="white"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>,
                },
                {
                  label: "Google Play", sub: "Get it on",
                  icon: <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0,0h40v40H0V0z"/><g><path d="M19.7,19.2L4.3,35.3c0.5,1.7,2.1,3,4,3c0.8,0,1.5-0.2,2.1-0.6l17.4-9.9L19.7,19.2z" fill="#EA4335"/><path d="M35.3,16.4l-7.5-4.3l-8.4,7.4l8.5,8.3l7.5-4.2c1.3-0.7,2.2-2.1,2.2-3.6C37.5,18.5,36.6,17.1,35.3,16.4z" fill="#FBBC04"/><path d="M4.3,4.7C4.2,5,4.2,5.4,4.2,5.8v28.5c0,0.4,0,0.7,0.1,1.1l16-15.7L4.3,4.7z" fill="#4285F4"/><path d="M19.8,20l8-7.9L10.5,2.3C9.9,1.9,9.1,1.7,8.3,1.7c-1.9,0-3.6,1.3-4,3L19.8,20z" fill="#34A853"/></g></svg>,
                },
              ].map((btn) => (
                <a
                  key={btn.label}
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg no-underline transition-all hover:bg-white/10 border border-white/15"
                  style={{ background: "rgba(255,255,255,0.06)" }}
                >
                  {btn.icon}
                  <div>
                    <div className="text-[9px] text-white/40 leading-tight">{btn.sub}</div>
                    <div className="text-[11px] font-bold text-white/80 leading-tight">{btn.label}</div>
                  </div>
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="list-none flex flex-col gap-2.5">
              {['Merchant Portal', 'Staff Web App', 'Customer Web App'].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="list-none flex flex-col gap-2.5">
              {['Help Center / FAQs', 'Merchant Guidebook', 'Contact Support'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-white/45 no-underline transition-colors duration-200 hover:text-[var(--loyawin-primary-light)]">
                    {item}
                  </a>
                  ...
                  {languages.map((lang) => (
                    <li key={lang.code}>
                      <button
                        ...
                        style={{ color: lang.code === language ? 'white' : 'rgba(255,255,255,0.55)' }}
                      >
                        <span>{lang.flag}</span>
                        <span>{lang.name}</span>
                      </button>
